import { useRef, Dispatch, useState, FormEvent, SetStateAction } from "react";
...
const schema = yup.object().shape({
  ...
  staffId: yup.string().required("Enter valid id"),
  status: yup.string().required(),
  dependants: yup.array().optional(),
});
    ...
    <div className="my-5 sm:my-0">
      ...
      <form onSubmit={onFinish}>
        ...
        <div className="mt-5">
          ...
          <DatePicker
            onChange={(_, date) => setDates({ ...dates, startDate: date })}
        ...
        <div className="mt-5">
          ...
          <DatePicker
            onChange={(_, date) => setDates({ ...dates, endDate: date })}
            className="w-full p-[12px]"
          />
        </div>
        <Input
